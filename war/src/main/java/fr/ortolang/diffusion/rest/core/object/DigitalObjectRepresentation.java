...
public class DigitalObjectRepresentation {
	...
	public DigitalObjectRepresentation() {
	}
	...
	public static DigitalObjectRepresentation fromDigitalObject(DigitalObject object) {
		DigitalObjectRepresentation representation = new DigitalObjectRepresentation();
