...
class PiwikAllCollector extends PiwikCollector {

    private static final Logger LOGGER = Logger.getLogger(PiwikAllCollector.class.getName());

    PiwikAllCollector(List<String> workspaces) throws OrtolangException {
        super(workspaces);
    }
