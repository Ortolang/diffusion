...
public class PiwikGenericCollector extends PiwikCollector {

    private static final Logger LOGGER = Logger.getLogger(PiwikGenericCollector.class.getName());

    String range;

    protected long timestamp;

    PiwikGenericCollector(List<String> workspaces) throws OrtolangException {
        super(workspaces);
    }

    PiwikGenericCollector(List<String> workspaces, String range, long timestamp) throws OrtolangException {
        super(workspaces);
        this.range = range;
