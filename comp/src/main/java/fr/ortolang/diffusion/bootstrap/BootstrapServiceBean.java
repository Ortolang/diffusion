...
public class BootstrapServiceBean implements BootstrapService {
    ...
    public void bootstrap() throws BootstrapServiceException {
        ...
        try {
            ...
            loadMetadataFormat(MetadataFormat.AIP, "Schema for AIP in JSON format", "", false, false);
            loadMetadataFormat(MetadataFormat.FICHMETA, "Schema for FichMeta from aip.xml in JSON format", "", false, false);
            ...
            loadMetadataFormat(MetadataFormat.CMDI, "Schema for CMDI metadata in JSON format", "", true, true);
