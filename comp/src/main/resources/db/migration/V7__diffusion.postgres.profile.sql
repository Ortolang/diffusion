    ...
    alter table Collection_segments 
        drop constraint FK_qtkd8pouce5ufvwfwj4bgsk8u;

    alter table Profile_infos 
        drop constraint FK_5dmu1n4w0bx2vaucrqr4mog87;

    alter table Profile_keys 
        drop constraint FK_dq11bmpucl4gg88ldggue1qvr;

    drop table if exists AuthorisationPolicy cascade;

    drop table if exists Collection cascade;

    drop table if exists Collection_segments cascade;
    ...
    drop table if exists MetadataObject cascade;
    ...
    drop table if exists Profile_keys cascade;

    drop table if exists RegistryEntry cascade;

    drop table if exists Workspace cascade;

    drop table if exists WorkspaceId cascade;

    drop table if exists "GROUP" cascade;

    drop sequence SEQ_WSID_PK;
