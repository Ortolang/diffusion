...
public class WorkflowTaskRepresentation {
	...
	public WorkflowTaskRepresentation() {
	}
	...
	public static WorkflowTaskRepresentation fromWorkflowTask(WorkflowTask task) {
		WorkflowTaskRepresentation representation = new WorkflowTaskRepresentation();
