...
public class PublicationServiceBean implements PublicationService {
	...
	@Override
	public void publishForAll(String key) throws PublicationServiceException, AccessDeniedException {
		logger.log(Level.FINE, "publishing key");
		try {
			String caller = membership.getProfileKeyForConnectedIdentifier();
			//TODO add a checkUserInGroup to allow for moderators
